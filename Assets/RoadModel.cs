...
public class RoadModel
{
    ...
    public Vector3[] RoadMiddlePoints;
    public Vector3[] RoadRightPoints;
    public Vector3[] RoadLeftPoints;
    //public Queue<>;



    public RoadModel(List<Vector3> nodes)
    {
        this.nodes = nodes;
        calculateTimes();
    }
    ...
    void calculateTimes()
    {
        ...
        RoadMiddlePoints = new Vector3[kFinalCount];
        RoadRightPoints = new Vector3[kFinalCount];
        RoadLeftPoints = new Vector3[kFinalCount];
        ...
        for (var kCount = 0; kCount < kFinalCount; kCount++)
        {
            ...
            RoadMiddlePoints[kCount] = new Vector3(myVect.x, myVect.y, myVect.z);
            RoadRightPoints[kCount] = new Vector3(myVect.x + tempa, myVect.y, myVect.z + tempb);
            RoadLeftPoints[kCount] = new Vector3(myVect.x - tempa, myVect.y, myVect.z - tempb);
        }
    }
